...
![Zabbix Postfix Agent Architecture](./postfix_agent_architecture.png)
...
![Postfix Email Lifecycle with Monitoring Points](./postfix_email_lifecycle.png)
...
![Postfix Metrics Collection Cycle](./postfix_metrics_collection_cycle.png)
...
![Postfix Zabbix Metrics by Category](./postfix_metrics_by_category.png)
...
![Postfix Problem Detection and Alerting Flow](./postfix_alerting_flow.png)
